...
/**
 * check_elf - Entry of program
 * Description: Checks if a file is ELF file.
...
/**
 * print_magic - Entry of program
 * Description: Prints the magic numbers of ELF
 * @e_ident: A pointer containing the ELF magic numbers.
 *
 */
void print_magic(unsigned char *e_ident)
...
/**
 * print_osabi - Entry of program
 * Desccription: Prints OS/ABI of ELF header.
 * @e_ident: A pointer containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * print_type - Entry of program
 * Description: Prints the type of ELF
 * @e_type: ELF type.
 * @e_ident: A pointer containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * print_entry - Entry of program
 * Description: Prints entry point of ELF header.
